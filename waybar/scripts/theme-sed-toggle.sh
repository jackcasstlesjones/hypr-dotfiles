...
if [[ "$CURRENT_THEME" == "nord" ]]; then
    ...
    sed -i 's|~/Downloads/wallpapers/.*|~/Downloads/wallpapers/rats.jpg|g' "$HYPRPAPER_FILE"
    ...
    sed -i 's|~/Downloads/wallpapers/.*|~/Downloads/wallpapers/arch.png|g' "$HYPRPAPER_FILE"
